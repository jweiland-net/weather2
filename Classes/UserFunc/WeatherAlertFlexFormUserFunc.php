...
/**
 * WeatherAlertFlexFormUserFunc
 */
class WeatherAlertFlexFormUserFunc
{
    /**
    ...
    public function getSelection(&$fConfig) {
        ...
        $result = $dbConnection->exec_SELECTgetRows('region_name', 'tx_weather2_domain_model_weatheralert', '1', 'name', 'name');
